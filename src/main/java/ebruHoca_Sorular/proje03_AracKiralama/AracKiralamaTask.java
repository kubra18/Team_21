package ebruHoca_Sorular.proje03_AracKiralama;

public class AracKiralamaTask {
    /*
    ***********  Araba Kiralama Projesi TASK   ***********
        Bir araç kiralama projesi hazırlayınız.
        Arac Talebi adında bir POJO class oluşturunuz. (POJO class fields yani variable'lari private yaptigimiz, getter ve setter'lari, constructorlari olusturdugumuz
        sayfadir).
    ...
    Runner isimli class create ediniz
    Main method bu class icerisinde olacak ve  MusteriveAracBilgileri class'inda olusturulan methodlar
    Runner class'indan cagrilacaktir.
     */
}
